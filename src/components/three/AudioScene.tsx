...
export const sceneRegistry: {
   ...
   */
  beatDetectors: Set<{ reset: () => void; resetForExport?: () => void; resetPhaseAndPrevBins?: () => void }>;
} = {
  gl: null,
  scene: null,
  camera: null,
 ...
 */
export function useBeatDetectorRegistration(detector: { reset: () => void; resetForExport?: () => void; resetPhaseAndPrevBins?: () => void } | null) {
  useEffect(() => {
    if (!detector) return;
